class GetInvolvedController < ApplicationController
  ...
  # Could feasibly be done via SearchAPI calls but there is no direct or indirect way to search by closing date
  # there so we have to go around the houses a bit via a single large P-API call.
